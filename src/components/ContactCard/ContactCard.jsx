...
export const ContactCard = () => {
    ...
    return (
        <section ref={contactCardRef} className='flex mr-auto ml-auto max-w-7xl'>
            <MainPill as='div' additionalClasses='flex flex-col items-center justify-center h-[264px] w-[60%] mr-auto rounded-3xl'>
            ...
            <MainPill as='div' additionalClasses='h-[264px] w-[40%] mr-auto ml-2 rounded-3xl flex justify-center'>
