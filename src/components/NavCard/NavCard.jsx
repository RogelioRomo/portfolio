...
export const NavCard = () => {
    return (
        <nav className='bg-custom-black bg-stardust-pattern flex items-center justify-between max-w-7xl mr-auto ml-auto py-4 px-8 rounded-full'>
            <Link to='/' className='text-custom-orange no-underline text-xl font-semibold'>
                rogelio romo.
            </Link>
