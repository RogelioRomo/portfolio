...
export const ProjectSection = () => {
  ...
  return (
    <MainPill as='section' additionalClasses='flex flex-col max-w-7xl mr-auto ml-auto rounded-3xl display-inline'>
      ...
      <div>
        <Link to='https://discoland.vercel.app/' target='_blank'><img className='h-[264px] sm:h-[768px] mb-2 rounded-3xl' src='/static/images/discoland-preview.png' title='discoland preview' alt='discoland preview' /></Link>
      </div>
    </MainPill>
  )
}
