...
export const ProjectSection = () => {
    return(
        <section className='bg-custom-black bg-stardust-pattern flex flex-col max-w-7xl mr-auto ml-auto mt-2 py-4 px-8 rounded-3xl border-2 border-transparent hover:border-custom-gray2 display-inline'>
            ...
            <div>
            <Link to='https://discoland.vercel.app/' target='_blank'><img className='h-[768px] mb-2 rounded-3xl' src='/public/discoland-preview.png' title='discoland preview' alt='discoland preview'></img></Link>
            </div>
        </section>
    )
}